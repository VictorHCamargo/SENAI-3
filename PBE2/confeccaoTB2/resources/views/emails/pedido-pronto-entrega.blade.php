...
<head>
    <meta charset="utf-8">
    <title>Pedido Pronto para Entrega</title>
</head>
    ...
    <div style="max-width: 720px; margin: 0 auto; padding: 32px 20px;">
        <div style="background: #ffffff; border: 1px solid #e5e7eb; border-radius: 8px; overflow: hidden;">
            <div style="background: #10b981; color: #ffffff; padding: 20px 24px;">
                <h1 style="margin: 0; font-size: 22px;">Pedido #{{ $pedido->id }} pronto para entrega</h1>
                <p style="margin: 6px 0 0;">O pedido foi movido para o status Para Entrega.</p>
            </div>
