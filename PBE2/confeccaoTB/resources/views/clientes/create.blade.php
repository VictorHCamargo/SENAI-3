                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="cpf" id="cpf" pattern="\d{3}\.\d{3}\.\d{3}-\d{2}" value="{{ old('cpf') }}" placeholder="000.000.000-00"
                                        class="w-full border-gray-200 rounded-lg focus:border-indigo-500 focus:ring-indigo-500 text-gray-800 shadow-sm">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="telefone" id="telefone"  pattern="^(\(?\d{2}\)?\s?)?9?\d{4}-?\d{4}$" value="{{ old('telefone') }}" placeholder="(00) 00000-0000"
                            ...
                            <div>
                                ...
                                <textarea name="endereco" id="endereco" rows="3"
                                    class="w-full border-gray-200 rounded-lg focus:border-indigo-500 focus:ring-indigo-500 text-gray-800 shadow-sm">{{ old('endereco') }}</textarea>
                            ...
                            <div class="flex items-center justify-end mt-4 pt-4 border-t border-gray-50">
                                ...
                                <button type="submit" class="bg-gray-800 hover:bg-gray-900 text-white font-bold py-2 px-6 rounded-lg transition-colors shadow-md text-sm">
                                    Salvar Cliente
                                </button>
                            </div>
                        </div>
